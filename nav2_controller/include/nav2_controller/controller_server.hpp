...
protected:
  ...
  //订阅teb路径
  rclcpp::Subscription<nav_msgs::msg::Path>::SharedPtr teb_path_sub_;

#if CAR_TYPE == 2
  //订阅FW车型底盘信息
  rclcpp::Subscription<yhs_can_interfaces::msg::FwChassisInfoFb>::SharedPtr fw_chassis_sub_;
#endif
  ...
  nav_msgs::msg::Path teb_path_;

#if CAR_TYPE == 2
  yhs_can_interfaces::msg::FwChassisInfoFb fw_chassis_;
#endif
...
private:
  ...
  void tebPathCallback(const nav_msgs::msg::Path::SharedPtr msg);

#if CAR_TYPE == 2
  void FwChassisCallback(const yhs_can_interfaces::msg::FwChassisInfoFb::SharedPtr msg);
#endif
